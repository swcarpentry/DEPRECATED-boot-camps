...
Setting up Bitbucket at first requires a user name and password. Let's now  [create a free one](https://github.com/signup/free). If you want to start paying, you can add that to your account some other day!
