This exercise will use NumPy to create a recommendation engine for academic papers.
...
Write some tests
------------------------------------------
Use Nose to write some tests for your code. Specifically, think about how you can test the input code and the distance measurements.
...
Add the following code to a file called inputdata.py. Then you can import the data directly using:
