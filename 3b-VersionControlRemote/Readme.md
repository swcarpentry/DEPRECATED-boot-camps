...
While you probably already have a copy of the 2012-10-gmu repository,
GitHub doesn't know about it yet. You'll need to tell github you want to
have an official fork of this repository.

Step 1 : Go to our
[repository](https://github.com/swcarpentry/2012-10-gmu) from your browser, and
click on the Fork button. Choose to fork it to your username rather than
any organizations.

Step 2 : Clone it. From your terminal :

    $ git clone git@github.com:username/2012-10-gmu.git
    $ cd 2012-10-gmu

Step 3 :

    $ git remote add upstream git://github.com:swcarpentry/2012-10-gmu.git
    $ git remote -v
    origin  git@github.com:username/2012-10-gmu.git (fetch)
    origin  git@github.com:username/2012-10-gmu.git (push)
    upstream        git://github.com/swcarpentry/2012-10-gmu.git (fetch)
    upstream        git://github.com/swcarpentry/2012-10-gmu.git (push)
...
want your master branch to track updates in the original 2012-10-gmu
...
this case swcarpentry/2012-10-gmu) into your local working copy, you
...
fork on github, (https://github.com/username/2012-10-gmu/).
...
alterations,
    ...
    To git@github.com:username/2012-10-gmu.git
