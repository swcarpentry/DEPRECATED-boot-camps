...
Let's say we want to know more about the string type. ? displays more information about each datatype/ function. Let's try str?.
...
***Excercise***
Can you find withhelp of the ? which function turns "Hello world" into "HELLO WORLD"?
